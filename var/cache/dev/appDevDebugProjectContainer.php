...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PW0YnMP3m8', 0, 'a06Zg5I4Fc0Zd5Ho8Fo7vQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Od-d6OWP0U', 0, 'a06Zg5I4Fc0Zd5Ho8Fo7vQ', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bQjuApzSsG', 0, 'a06Zg5I4Fc0Zd5Ho8Fo7vQ', (__DIR__.'/pools'), $a));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => $b, 1 => new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', 'apiKey', NULL), 2 => $c, 3 => $q), 'main', $a, $e, $f), 2 => $t, 3 => $u, 4 => $y, 5 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($d, $h, 'main', $z, $a), 6 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $s, $h, $a, $e, true, $v), 7 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '582f07729bccd2.27745494', $a, $h), 8 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($d, $b, $this->get('security.user_checker.main'), 'main', $j, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $e), 9 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $j, $p, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $f, $r, 'main', $z, NULL, NULL, $a, false));
    }
