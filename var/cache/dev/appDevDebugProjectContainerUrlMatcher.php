...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // admin_route
        if ($pathinfo === '/admin') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::adminAction',  '_route' => 'admin_route',);
        }

        // 
        if ($pathinfo === '/contact') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::contactAction',  '_route' => '',);
        }

        // target_route
        if ($pathinfo === '/test') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::testRoute',  '_route' => 'target_route',);
        }

        // new_route
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'new_route');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::newAction',  '_route' => 'new_route',);
        }
        ...
        // morse_test
        if ($pathinfo === '/morse') {
            return array (  '_controller' => 'AppBundle\\Controller\\MorseController::indexAction',  '_route' => 'morse_test',);
        }

        if (0 === strpos($pathinfo, '/posts')) {
            // post_show
            if (preg_match('#^/posts/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_show')), array (  '_controller' => 'AppBundle\\Controller\\PostController::showAction',));
            }
