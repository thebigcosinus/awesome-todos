...
class appDevDebugProjectContaine_ extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.image_type_extension' => 'getApp_ImageTypeExtensionService',
            'app.switch_user_listener' => 'getApp_SwitchUserListenerService',
            'app.token_authenticator' => 'getApp_TokenAuthenticatorService',
            'app.webservice_user_provider' => 'getApp_WebserviceUserProviderService',
            ...
            'security.user.provider.concrete.my_db_provider' => 'getSecurity_User_Provider_Concrete_MyDbProviderService',
    ...
    /**
     * Gets the 'app.image_type_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Extension\ImageTypeExtension A AppBundle\Form\Extension\ImageTypeExtension instance
     */
    protected function getApp_ImageTypeExtensionService()
    {
        return $this->services['app.image_type_extension'] = new \AppBundle\Form\Extension\ImageTypeExtension();
    }

    /**
     * Gets the 'app.switch_user_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\SwitchUserListener A AppBundle\EventListener\SwitchUserListener instance
     */
    protected function getApp_SwitchUserListenerService()
    {
        return $this->services['app.switch_user_listener'] = new \AppBundle\EventListener\SwitchUserListener();
    }
    ...
    {
        return $this->services['app.token_authenticator'] = new \AppBundle\Security\TokenAuthenticator();
    }

    /**
     * Gets the 'app.webservice_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\User\WebserviceUserProvider A AppBundle\Security\User\WebserviceUserProvider instance
     */
    protected function getApp_WebserviceUserProviderService()
    {
        return $this->services['app.webservice_user_provider'] = new \AppBundle\Security\User\WebserviceUserProvider();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sp5Lz+7MjX', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PW0YnMP3m8', 0, 'Sx1MQwjESFzHEJeS8TtNmQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Od-d6OWP0U', 0, 'Sx1MQwjESFzHEJeS8TtNmQ', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bQjuApzSsG', 0, 'Sx1MQwjESFzHEJeS8TtNmQ', (__DIR__.'/pools'), $a));
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('security.switch_user', array(0 => 'app.switch_user_listener', 1 => 'onSwitchUser'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'amazingtodos', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_61db2d64ac068a093ab9132142a61e18073bcc9343caf59415f244ef79600a78');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $b = $this->get('security.user.provider.concrete.my_db_provider');
        $c = $this->get('security.user.provider.concrete.in_memory');
        ...
        $g = $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        $h = $this->get('security.authentication.manager');
        $i = $this->get('http_kernel');
        $j = $this->get('debug.security.access.decision_manager');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/users');
        ...
        $p->add($k, array(0 => 'ROLE_API'), NULL);
        $p->add($l, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $p->add($m, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $p->add($n, array(0 => 'ROLE_ADMIN'), NULL);
        $p->add($o, array(0 => 'ROLE_USER'), NULL);

        $q = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c));

        $r = new \Symfony\Component\Security\Http\HttpUtils($g, $g);

        $s = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b, 1 => $q), '18254152e44a320ce34a69e55276fcf668d41376', 'main', array('lifetime' => 604800, 'path' => '/', 'name' => 'amazingtodosrememberme', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $t = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $r, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($r, '/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $t->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $t->addHandler($s);

        $u = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $h, 'main', array(0 => $this->get('app.token_authenticator')), $a);
        $u->setRememberMeServices($s);

        $v = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate');

        $w = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($r, array());
        $w->setOptions(array('login_path' => 'login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $w->setProviderKey('main');

        $x = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($i, $r, array(), $a);
        $x->setOptions(array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $y = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $h, $v, $r, 'main', $w, $x, array('check_path' => 'login', 'csrf_parameter' => '_csrf_security_token', 'csrf_token_id' => 'authenticate', 'username_parameter' => '_username', 'password_parameter' => '_password', 'post_only' => true, 'use_forward' => false, 'require_previous_session' => true), $a, $e, $this->get('security.csrf.token_manager'));
        $y->setRememberMeServices($s);

        $z = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($i, $r, 'login', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => $b, 1 => new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', 'apiKey', NULL), 2 => $c, 3 => $q), 'main', $a, $e, $f), 2 => $t, 3 => $u, 4 => $y, 5 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($d, $h, 'main', $z, $a), 6 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $s, $h, $a, $e, true, $v), 7 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '582f1241ccc7d4.04335999', $a, $h), 8 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($d, $b, $this->get('security.user_checker.main'), 'main', $j, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $e), 9 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $j, $p, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $f, $r, 'main', $z, NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('18254152e44a320ce34a69e55276fcf668d41376');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('app.token_authenticator')), $this->get('security.user.provider.concrete.my_db_provider'), 'main', $a), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), $a, 'main', $this->get('security.encoder_factory'), true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '18254152e44a320ce34a69e55276fcf668d41376', 'main'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582f1241ccc7d4.04335999')), true);
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('ryan', '$2y$12$fc14DPQ/2ewzJ3d2FCrJQuZnjPmKGCbE1QGMnsvtm1RqtYlDaDJia', array(0 => 'ROLE_USER')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$12$RZZLdf5Jnylx4z6W3cjMV.vCwaajIBVqoyRCjYv0Yw5HRa5vNPVPu', array(0 => 'ROLE_ADMIN')));

        return $instance;
    }

    /**
     * Gets the 'security.user.provider.concrete.my_db_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_MyDbProviderService()
    {
        return $this->services['security.user.provider.concrete.my_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '18254152e44a320ce34a69e55276fcf668d41376',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '18254152e44a320ce34a69e55276fcf668d41376',
